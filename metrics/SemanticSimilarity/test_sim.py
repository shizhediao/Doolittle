...
model = torch.load('Please download file \"sim.pt\" from https://github.com/martiansideofthemoon/style-transfer-paraphrase/tree/master/style_paraphrase/evaluation and put its absolute path here')
...
sp.Load('Please download file \"sim.sp.30k.model\" from https://github.com/martiansideofthemoon/style-transfer-paraphrase/tree/master/style_paraphrase/evaluation and put its absolute path here')
model.eval()
